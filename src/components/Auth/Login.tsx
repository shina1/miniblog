...
const Login = ({setIsLogIn}:loginProps) => {
  ...
  return (
    <div className='flex flex-col items-center justify-center gap-5 w-[90%] lg:w-[30%] h-[55vh] lg:h-[45vh] ml-auto mr-auto mt-20 lg:mt-40 shadow-md shadow-black'>
      ...
      <button className='bg-[#FF7606]/80 text-white md:flex  items-center gap-2 py-2 rounded-full border-none' onClick={(e)=> authSigninWithGoogle(e,setIsLogIn, navigate)}>
        Sign in with Google
      </button>
    </div>
  )
